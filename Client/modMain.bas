...
Public Function Chat_ChatSend(rmtext As String) As String
    REN = "1¿Ä" & UserName & "¿Ä104¿Ä" & RoomName & "¿Ä117¿Ä" & rmtext & "¿Ä124¿Ä1¿Ä"
...
Public Sub PM_Send(txtToWhom As String, PMData As String, sckSend As Winsock)
    ...
    REN = "5¿Ä" & txtToWhom & "¿Ä4¿Ä" & UserName & "¿Ä8¿ÄNone" & "¿Ä14¿Ä" & PMData & "¿Ä97¿Ä1¿Ä"
...
Public Sub BootHim(txtToWhom As String, sck As Winsock)
    Dim Data2Send
    REN = "4¿Ä" & UserName & "¿Ä2¿Äboo¿Ä5¿Ä" & txtToWhom & "¿Ä5¿Ä" & txtToWhom & "ß¿Ä5¿Ä" & txtToWhom & "ßß¿Ä5¿Ä" & txtToWhom & "ßßß¿Ä13¿Ä4¿Ä49¿ÄPEERTOPEER¿Ä14¿Ä2¿Ä16¿Ä0¿Ä¿Ä"
...
Public Sub Add_Me(txtToWhom As String, SendData As String, Optional GroupName As String = "Friends", Optional sckAdd As Winsock)
    ...
    REN = "1¿Ä" & UserName & "¿Ä7¿Ä" & txtToWhom & "¿Ä14¿Ä" & SendData & "¿Ä65¿Ä" & GroupName & "¿Ä"
...
Public Function CamInvite(txtToWhom As String) As String
    REN = "49¿ÄWEBCAMINVITE¿Ä14¿Ä ¿Ä13¿Ä0¿Ä1¿Ä" & UserName & "¿Ä5¿Ä" & txtToWhom & "¿Ä1002¿Ä2¿Ä"
...
Public Function VoiceInvite(WhoTo As String, from As String, sck As Winsock) As String
    REN = "1¿Ä" & from & "¿Ä5¿Ä" & WhoTo & "¿Ä57¿Ä" & from & "-21723¿Ä13¿Ä1¿Ä"
...
Sub SendFiles(WhoTo As String, WhoFrom As String, FileName As String, sckSendFile As Winsock)
    ...
    Dim B, a, c As String
    B = "5¿Ä" & WhoTo & "¿Ä4¿Ä" & WhoFrom & "¿Ä49¿ÄFILEXFER¿Ä1¿Ä" & WhoFrom & "¿Ä13¿Ä1¿Ä27¿Ä" & FileName & "¿Ä28¿Ä720896¿Ä20¿Ä"
    Dim mp As Integer
    mp = Len(B)
...
Sub ChangeStatus(StatusID As Integer, sckStatus As Winsock, Optional CustomMessage As String, Optional IsBusy As Boolean = True)
    Dim a As String
    REN = "10¿Ä" & CStr(StatusID)
    If StatusID = 99 Then
        REN = REN & "¿Ä19¿Ä" & CustomMessage & "¿Ä47¿Ä"
    Else
        REN = REN & "¿Ä47¿Ä"
    End If
    If IsBusy Then
